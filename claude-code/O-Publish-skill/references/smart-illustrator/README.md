...
Intelligent article illustration Skill for Claude Code with **dual-engine system**: automatically selects Mermaid (for structured diagrams) or the Sophnet image engine (for creative visuals) based on content type.
...
Creating illustrations for articles is time-consuming: manual design takes hours, stock photos lack context, and generic AI tools don't understand article structure. Smart Illustrator combines intelligent position detection, dual-engine system (Mermaid + Sophnet image generation), and cover learning to generate contextual illustrations in minutes.
...
- **Dual Engine System**: Auto-selects Mermaid or Sophnet image generation based on content type
...
- **Multiple Backends**: Mermaid CLI for diagrams, Sophnet image API for creative visuals (2K resolution)
...
| **Sophnet Image** | Creative visuals (metaphors, scenes, infographics) | Artistic, atmospheric, branded |
...
| `concept` | Sophnet Image | Abstract concepts | Center-radial |
| `comparison` | Sophnet Image | A vs B, contrasts | Left-right split |
